---
title: "**EC 339--001: Applied Econometrics**"
...
\begin{tabular}{ll|l} 
	...
	\textbf{Where:} & \multicolumn{2}{l}{CIS 311 (\href{https://www.skidmore.edu/directions/maps.php}{\texttt{map}})} \\
	...
	\textbf{Web:} & \, \faPencil \, \href{https://github.com/marciosantetti/ec339-fall23/blob/main/README.md}{\texttt{Course website}} \\
\end{tabular}
...
The most affordable option is its `eTextbook` version, available at the [`Pearson website`](https://www.pearson.com/en-us/subject-catalog/p/using-econometrics-a-practical-guide/P200000006422/9780137506323). In case students prefer other formats, this link also contains different options.

\bigskip

While the course structure is strongly inspired by this textbook, a more diverse approach to the proposed topics will be adopted in class. Additional references are listed below.
...
* **Dec 15**: Final exam, our classroom (9:00 AM--12:00 PM)
...
* Stay in the classroom during the *entire* lecture. Use the bathroom/fill your water bottles before coming!
...
* **Week 9**: Violations of CLRM Assumptions II: Multicollinearity.

* **Week 10**: Violations of CLRM Assumptions III: Serial Correlation.

* **Week 11**: Violations of CLRM Assumptions IV: Heteroskedasticity.

* **Week 12**: Binary Dependent Variable Models.

* **Week 13**: Open for content adjustments.
