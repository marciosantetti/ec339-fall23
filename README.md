...
**Week 11: Binary dependent-variable models**
  ...
  - Stata do-file: [`010-binary-models.do`](https://github.com/marciosantetti/ec339-fall23/blob/main/lectures/010-binary-models/010-binary-models.do) | To download, see `theSpring` module
  - Data files available for download on `theSpring`.
